...
RFC 2817 - I<Upgrading to TLS Within HTTP/1.1>, section 5.2 - I<Requesting a Tunnel with CONNECT>

This protocol is only supported in client mode.

=item I<imap>

RFC 2595 - I<Using TLS with IMAP, POP3 and ACAP>

=item I<nntp>

RFC 4642 - I<Using Transport Layer Security (TLS) with Network News Transfer Protocol (NNTP)>

This protocol is only supported in client mode.

=item I<pop3>

RFC 2449 - I<POP3 Extension Mechanism>

=item I<smtp>

RFC 2487 - I<SMTP Service Extension for Secure SMTP over TLS>
